(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,Html,Client,Default,List,SingleWebSharper,Client1,EventsPervasives,Remoting,AjaxRemotingProvider,Concurrency;
  ...
  SingleWebSharper:{
   Client:{
    ...
    Start:function(input,k)
    {
     ...
     {
      var x,f1;
      x=AjaxRemotingProvider.Async("SingleWebSharper:0",[input]);
      f1=function(_arg1)
      {
       var x1;
       x1=k(_arg1);
 ...
 Runtime.OnInit(function()
 {
  ...
  SingleWebSharper=Runtime.Safe(Global.SingleWebSharper);
  Client1=Runtime.Safe(SingleWebSharper.Client);
